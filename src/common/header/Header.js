...
const Header = (props) => {
    ...
    const [usernameRequired, setUsernameRequired] = useState("hideElement");
    const [loginPasswordRequired, setLoginPasswordRequired] = useState("hideElement");
    const [loginPassword, setloginPassword] = useState("");
    const [firstnameRequired, setFirstnameRequired] = useState("hideElement");
    const [firstname, setFirstname] = useState("");
    const [lastnameRequired, setLastnameRequired] = useState("hideElement");
    const [lastname, setLastname] = useState("");
    const [emailRequired, setEmailRequired] = useState("hideElement");
    const [email, setEmail] = useState("");
    const [registerPasswordRequired, setRegisterPasswordRequired] = useState("hideElement");
    const [registerPassword, setRegisterPassword] = useState("");
    const [contactRequired, setContactRequired] = useState("hideElement");
    ...
    const loginClickHandler = () => {
        username === "" ? setUsernameRequired("display-block") : setUsernameRequired("hideElement");
        loginPassword === "" ? setLoginPasswordRequired("display-block") : setLoginPasswordRequired("hideElement");
    ...
    const registerClickHandler = () => {
        firstname === "" ? setFirstnameRequired("display-block") : setFirstnameRequired("hideElement");
        lastname === "" ? setLastnameRequired("display-block") : setLastnameRequired("hideElement");
        email === "" ? setEmailRequired("display-block") : setEmailRequired("hideElement");
        registerPassword === "" ? setRegisterPasswordRequired("display-block") : setRegisterPasswordRequired("hideElement");
        contact === "" ? setContactRequired("display-block") : setContactRequired("hideElement");
