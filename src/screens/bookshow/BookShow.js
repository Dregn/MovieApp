...
const BookShow = (props) => {
  ...
  const [reqLocation, setReqLocation] = useState("hideElement");
  const [reqTheatre, setReqTheatre] = useState("hideElement");
  const [reqLanguage, setReqLanguage] = useState("hideElement");
  const [reqShowDate, setReqShowDate] = useState("hideElement");
  const [reqTickets, setReqTickets] = useState("hideElement");
  ...
  function theatreChangeHandler (event) {
  ...
  const languageChangeHandler = (event) => {
   ...
   function showDateChangeHandler (event) {
 ...
 function bookShowButtonHandler () {
    location === "" ? setReqLocation("display-block") : setReqLocation("hideElement");
    theatre === "" ? setReqTheatre("display-block") : setReqTheatre("hideElement");
    language === "" ? setReqLanguage("display-block") : setReqLanguage("hideElement");
    showDate === "" ? setReqShowDate("display-block") : setReqShowDate("hideElement");
    tickets === 0 ? setReqTickets("display-block") : setReqTickets("hideElement");
